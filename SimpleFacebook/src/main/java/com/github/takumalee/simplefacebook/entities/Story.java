...
import com.github.takumalee.simplefacebook.utils.GraphPath;
...
//		String namespace = SimpleFacebook.getConfiguration().getNamespace();
		return mStoryAction.getActionName();
	}

	public String getObjectType() {
//		String namespace = SimpleFacebook.getConfiguration().getNamespace();
		return mStoryObject.getNoun();
	}
...
//			mData = builder.data;
		...
		public static StoryObject create() {
